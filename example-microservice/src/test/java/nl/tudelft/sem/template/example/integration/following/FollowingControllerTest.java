...
public class FollowingControllerTest {
    ...
    public void test200OK() {
        when(followingService.followUser(1L, 2L)).thenReturn(HttpStatus.OK);

        ResponseEntity<GenericResponse> result = followingController.follow(2L, 1L);
    ...
    public void test400Bad_Request() {
        when(followingService.followUser(1L, 2L)).thenReturn(HttpStatus.BAD_REQUEST);
    ...
    public void test403Forbidden() {
        when(followingService.followUser(1L, 2L)).thenReturn(HttpStatus.FORBIDDEN);
    ...
    public void test500Internal_Server_Error() {
        when(followingService.followUser(1L, 2L)).thenReturn(HttpStatus.INTERNAL_SERVER_ERROR);
